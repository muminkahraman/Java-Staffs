...
public class Application {
    public static void main(String[] args) {
        ...
        try (FileOutputStream fos = new FileOutputStream(new File("./OutJava/Task3/Task41_out.txt"))) {//Here we use try-with-resources
            fos.write(data);
        ...
        try (InputStream inputStream = new FileInputStream(fichier)) { //Here we use try-with-resources
            int byteRead = -1;
