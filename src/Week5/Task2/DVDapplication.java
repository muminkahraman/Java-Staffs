...
public class DVDapplication {
    public static void main(String[] args) {
        ...
        Stack_ArrayDeque<DVD> DVDArrayDeque = createArrayDequeDVD(DVDArray);
    ...
    private static Stack_ArrayDeque<DVD> createArrayDequeDVD(DVD[] dvds){
        Stack_ArrayDeque<DVD> arraydeque = new Stack_ArrayDeque<>();
        for (DVD dvd : dvds) {
            try {
                arraydeque.push(dvd);
            } catch (Exception e) {
                System.out.println("ERROR (ArrayDeque): " + e.getMessage());
            }
        }
        return arraydeque;
    }
    ...
    private static void printCollections(Stack_ArrayDeque<DVD> arrayDeque, String arrayTitle, DVD[] dvds, String[] titles, Collection<DVD>... DVDCollection)
    {
