...
public class DVDApplication {
    ...
    public static void main(String[] args) {
        ...
        ArrayDeque<DVD> DVDArrayDeque = createArrayDeque_Of_DVD(DVDArray);
        ...
        String[] collectionTitles =
                {
                        ...
                        "\nDVD ArrayDeque (%d entries)\n"
                };


        printCollections(arrayTitle,DVDArray,collectionTitles,DVDList,DVDlist_NaturalOrder,DVDList_LActorOrder,DVDHashMap.values(),DVDTreeMap.values(),DVDTreeSet,DVDTreeSet_TitleOrder,DVDArrayDeque);
    ...
    private static ArrayDeque<DVD> createArrayDeque_Of_DVD(DVD[] DVDS)
    {
        ArrayDeque<DVD> deque = new ArrayDeque<>();
        for (DVD DVD : DVDS)
        {
            deque.add(DVD);
        }
    ...
    {
        for (Week5.Task2.Task2L.DVD DVD : DVDS)
        {
