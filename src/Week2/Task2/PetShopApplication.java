...
public class PetShopApplication {
    ...
    public static void main(String[] args) {
        ...
        pets[5] = new Cat("cat3", "owner3", 3, 3);
        ...
        System.out.println("the test result should be \"true\", actual result : " + pets[2].equals(pets[5]));
        System.out.println("the test result should be \"false\", actual result : " + pets[2].equals(pets[3]));
