...
public class Lecture9Demo
{
    ...
    {
        try (Scanner input = new Scanner(new File("src/Week9/Task3/test/BookList.txt")))
        {
            books = new Gson()
                    .fromJson(
                            input.nextLine(),
    ...
    {
        try (PrintWriter output = new PrintWriter("src/Week9/Task3/test/BookList.txt"))
        {
